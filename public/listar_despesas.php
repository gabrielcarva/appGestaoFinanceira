...
<div class="container mt-5">
    ...
    <table class="table table-striped mt-4">
        ...
        <tbody id="despesasTable">
            <!-- As despesas ser�o carregadas aqui -->
        </tbody>
    </table>
</div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="editarDespesaForm">
                    ...
                    <div class="mb-3">
                        <label for="editarDescricao" class="form-label">Descri��o</label>
...
<script>
        ...
        try {
            ...
            despesas.forEach(despesa => {
                ...
                row.innerHTML = `
                    ...
                    <td>${despesa.data}</td>
                    <td>${despesa.descricao || 'Sem descri��o'}</td>
                    <td>
    ...
    async function salvarEdicao() {
        ...
        try {
            ...
            console.error('Erro ao salvar edi��o:', error);
        }
    }
